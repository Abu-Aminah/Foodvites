    ...
    <>
      {showPopup && (
        <div>
          ...
          >
            <div
              className="fixed top-1/6 left-1/4
                     translate-y-1/2 translate-x-1/2 p-4 shadow-md
                      bg-white rounded-md duration-200 w-[300px]"
            >
              {/* header section  */}
              ...
              <div className="mt-4">
                <input
                  ...
                  className="w-full border border-x-gray-500 px-2
                     rounded-md py-1 mb-4"
                />
                <input
                  type="password"
                  placeholder="*****"
